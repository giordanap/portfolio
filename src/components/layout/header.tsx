    ...
    <header className="sticky top-0 z-50 border-b border-slate-800/70 bg-slate-950/80 backdrop-blur-xl">
      <div className="section-container flex min-h-16 items-center justify-between gap-4 py-3">
        <a href="#top" className="group flex min-w-0 items-center gap-3">
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-cyan-400/30 bg-cyan-400/10 text-sm font-bold text-cyan-200 shadow-[0_0_28px_rgba(34,211,238,0.12)]">
            GA
          </span>
